...
var Cite = (0, _radium2.default)(_class = function (_Component) {
  ...
  _createClass(Cite, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "cite",
        { className: this.props.className, style: [this.context.styles.components.cite, _base.getStyles.call(this), this.props.style] },
        "- ",
        this.props.children
      );
    }
